...
export const BUSINESS_CARDS_FLYOUT_SECTIONS: {
...
}[] = [
  {
    title: "Popular",
    items: [
      { label: "Standard", href: "/products/business-cards/standard", slug: "standard" },
      { label: "Square", href: "/products/business-cards/square", slug: "square" },
      {
        label: "Rounded Corner",
        href: "/products/business-cards/rounded-corner",
        slug: "rounded-corner",
      },
    ],
  },
  {
    title: "Premium",
    items: [
      { label: "Foil", href: "/products/business-cards/foil", slug: "foil" },
      { label: "Metal", href: "/products/business-cards/metal", slug: "metal" },
      {
        label: "Metallic Print",
        href: "/products/business-cards/metallic-print",
        slug: "metallic-print",
      },
      { label: "Plastic", href: "/products/business-cards/plastic", slug: "plastic" },
      {
        label: "Painted Edge",
        href: "/products/business-cards/painted-edge",
        slug: "painted-edge",
      },
      {
        label: "Raised Foil",
        href: "/products/business-cards/raised-foil",
        slug: "raised-foil",
      },
      {
        label: "Raised Spot UV",
        href: "/products/business-cards/raised-spot-uv",
        slug: "raised-spot-uv",
      },
      { label: "Silk", href: "/products/business-cards/silk", slug: "silk" },
      { label: "Spot UV", href: "/products/business-cards/spot-uv", slug: "spot-uv" },
      { label: "Velvet", href: "/products/business-cards/velvet", slug: "velvet" },
    ],
  },
  {
    title: "Shape",
    items: [
      { label: "Slim", href: "/products/business-cards/slim", slug: "slim" },
      {
        label: "Square Rounded Corner",
        href: "/products/business-cards/square-rounded-corner",
        slug: "square-rounded-corner",
      },
      { label: "Folded", href: "/products/business-cards/folded", slug: "folded" },
      { label: "Leaf", href: "/products/business-cards/leaf", slug: "leaf" },
      {
        label: "Slim Rounded Corner",
        href: "/products/business-cards/slim-rounded-corner",
